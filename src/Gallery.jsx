            ...
            <ul className="d-flex flex-wrap">
            {
                photos.map((a,i)=>{
                    ...
                    <div className="card-body d-flex flex-column" style={{position:'relative'}}>
                        ...
                        <button className="gallery"  onClick={()=>{addtoGallery(i)}} disabled={a.IsImageInGallery?true:false}>{a.IsImageInGallery?'Add it':'Add to Gallery'}</button>
                    </div>  
                ...
                album.length>0 && album.map((b,ind)=>{
                    return <div className="m-2 mb-4 ">
                       <div className="card-body d-flex flex-column" style={{position:'relative'}}>
                        ...
                        <span onClick={()=>{remove(b,ind)}} style={{position:'absolute',left:'130px',fontSize:'large',top:'-6px',backgroundColor:'white'}}>{<AiOutlineCloseCircle></AiOutlineCloseCircle>}</span>
